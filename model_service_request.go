...
type ServiceRequest struct {
	...
	VirtualMachine       NullablePatchedWritableServiceRequestVirtualMachine `json:"virtual_machine,omitempty"`
...
func (o *ServiceRequest) GetVirtualMachine() PatchedWritableServiceRequestVirtualMachine {
	if o == nil || IsNil(o.VirtualMachine.Get()) {
		var ret PatchedWritableServiceRequestVirtualMachine
		return ret
	}
...
// SetVirtualMachine gets a reference to the given NullablePatchedWritableServiceRequestVirtualMachine and assigns it to the VirtualMachine field.
