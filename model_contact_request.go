...
type ContactRequest struct {
	Group                NullableContactRequestGroup `json:"group,omitempty"`
...
// SetGroup gets a reference to the given NullableContactRequestGroup and assigns it to the Group field.
